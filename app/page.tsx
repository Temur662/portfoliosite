       ...
       */}
        ...
        >
          ...
          <section className="max-w-[100%] md:max-w-[75%] h-auto"
            ref={IntroRef}
          >
            <h1 className="md:text-6xl text-6xl font-bold flex-col flex text-center self-center md:text-start md:self-start">
              <span className="text-white">SOFTWARE</span>
              <span className="text-gray-800">ENGINEER</span>
              <span className="text-gray-400 text-xl">Co-Founder of AppFlow Studios</span>
            </h1>
            <p className="text-gray-400 mt-4 max-w-md text-center self-center md:text-start md:self-start text-md">
            I'm passionate about crafting intuitive user experiences that not only look great but solve real-world problems.  I co-founded AppFlow Studios with a mission to create enjoyable and beautiful software solutions for businesses. Every project is an opportunity to blend creativity with technical excellence.
            </p>
          ...
          {/* Projects & Experience */}
          <section className="max-w-[100%] md:max-w-[75%] md:pt-10 pt-10 pb-[10px]"
            ref={ProjectsRef}
          >
            <h1 className="md:text-6xl text-6xl font-bold flex-col flex text-center self-center md:text-start md:self-start">
